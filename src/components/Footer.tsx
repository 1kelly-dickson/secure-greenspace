      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">SecureText</span>
            </div>
            <p className="text-gray-600 text-sm">
              Secure encryption for your messages and files. Your data never leaves your browser.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/encrypt" className="text-gray-600 hover:text-gray-900 text-sm">Encryption</Link></li>
              <li><Link to="/decrypt" className="text-gray-600 hover:text-gray-900 text-sm">Decryption</Link></li>
              <li><Link to="/hash" className="text-gray-600 hover:text-gray-900 text-sm">Hash Generator</Link></li>
              <li><Link to="/file-encrypt" className="text-gray-600 hover:text-gray-900 text-sm">File Encryption</Link></li>
              <li><Link to="/messaging" className="text-gray-600 hover:text-gray-900 text-sm">Secure Messaging</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {currentYear} SecureText. All rights reserved.
          </p>
